            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    @switch($locale)
                        ...
                        @break
                        @default
                        <img src="{{ URL::asset('/assets/images/flags/iran.png')}}" alt="Header Language" height="16">
                    @endswitch
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="{{ url('index/fa') }}" class="dropdown-item notify-item">
                        <img src="{{ Url::asset('assets/images/flags/iran.png') }}" alt="user-image" class="mr-1" height="12"><span class="align-middle">Iran</span>
                    </a>
                </div>
            </div>
